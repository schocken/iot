...
def customShadowCallback_Get(payload, responseStatus, token):
    ...
    if 'delta' in payloadDict['state']:
        ...
        return
    print("++++++++GET++++++++++")
    if 'potval' in payloadDict['state']['desired']:
        interval = int(payloadDict['state']['desired']['potval'])
...
def customShadowCallback_Delta(payload, responseStatus, token):
    ...
    print(payloadDict)
    print("++++++++DELTA++++++++++")
    if 'potval' in payloadDict['state']:
        potval = int(payloadDict['state']['potval'])
